fieldMask<-function(mosaic,Red=1,Green=2,Blue=3,RedEdge=NULL,NIR=NULL,mask=NULL,index="HUE",myIndex=NULL,cropValue=0,cropAbove=T, projection=T, DSMmosaic=NULL, DSMcropAbove=T, DSMcropValue=0, plot=T){
